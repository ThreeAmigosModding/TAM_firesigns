...
config.commands = {
    ...
    groups = false, -- The ace permission(s) (or job group(s), depending on framework) that have access to the commands. Set to false to allow everyone. Accepts table or string.
